...
# DumCaptions Installation Script (user systemd service)
...
echo -e "${BLUE}=== DumCaptions Installer ===${NC}"
...
JAR_FILE="target/dum-captions-1.0-SNAPSHOT.jar"
if [ ! -f "$JAR_FILE" ]; then
...
Description=DumCaptions Service
